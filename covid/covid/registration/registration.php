  ...
  if ($_SERVER["REQUEST_METHOD"]=="POST") {
          include "../database/_dbconnect.php";
            ...
            if ($numrow >0) {
              ...
              $sql = "INSERT INTO `usersid` (`username`, `email`, `password`,`phone`,DateOfBirth) VALUES (?, ?, ?, ?, ?)";
              $stmt = $conn->prepare($sql);
              $stmt->bind_param("sssss", $username, $email, $password, $phone,$DateOfBirth);
              if ($stmt->execute()) {
                $showmsg = true;
              } else {
                $showiderr = true;
                        ...
                        <div class=" custom-form p-5 pb-0 custom-border">
                            ...
                            <form action="registration.php" method="post">
                                <div class="mb-2 ">
                                    ...
                                    <input type="text" class="form-control bg-transparent  border border-success"
                                        name="username" placeholder="Enter your username" required>
                                </div>
                                <div class="mb-2">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control bg-transparent  border border-success"
                                        name="email" placeholder="Enter your email" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="phone" class="form-label">Phone Number</label>
                                    <input type="tel" class="form-control bg-transparent border border-success"
                                        name="phone" placeholder="Enter your Phone number" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="DOB" class="form-label">Date Of Birth</label>
                                    <input type="date" class="form-control bg-transparent border border-success"
                                        name="DOB" required>
                                </div>
                                ...
                                <div class="singleline">
                                    <div class="toggle-row">
                                        ...
                                        <label for="check1" class="btm">Do you have corona?</label>
                                    </div>

                                    <div class="toggle-row">
                                        <input type="checkbox" id="check2" class="toggle">
                                        <label for="check2" class="btm check2">First vaccine completed?</label>
                                    </div>
                                </div>


                                <input type="checkbox" id="check3" class="toggle">
                                <label for="check3" class="btm">Second vaccine completed?</label>

                                <div class="mb-3">
                                    <label for="password" class="form-label">Password</label>
                                    <input type="password" class="form-control bg-transparent  border border-success"
                                        name="mypass" placeholder="Enter your password" required>
                                </div>
                                <div class="mb-3">
                                    <label for="confirmPassword" class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control bg-transparent  border border-success"
                                        name="confirmMypass" placeholder="Confirm your password" required>
                                </div>
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input   border border-success" id="check"
                                        required>
                                    <label class="form-check-label" for="check">I agree to the terms and
                                        conditions</label>
                                </div>
                                ...
                                <p class="text-center text-muted mt-4">Already have an account? <a
                                        href="../Login/login.php" class="fw-bold text-body"><u>Login here</u></a></p>
                            </form>
                        </div>
                    </div>
                </div>
