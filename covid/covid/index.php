...
echo '
            <li><button class="mlm"><a href="registration/registration.php">Registration </a></button></li>
            <li><button><a href="Login/login.php">Login </a></button></li>';
          }
            else {
              echo'
              <li><button><a href="Login/logout.php">Log Out </a></button></li>';
            }
            ?>
                </ul>
            </div>
    ...
    <section class="contact">
        ...
        <div class="form">
            <input type="text" placeholder="kishansheth21@gmail.com" />
            <button>Send</button>
        </div>
    </section>
    <footer>
    ...
    <span class="copyright">2021 &copy; All rights reserved by Kishan Sheth</span>
