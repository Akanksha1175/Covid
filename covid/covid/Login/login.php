      ...
      <div class="row d-flex justify-content-center h-100 ">
        <div class="col-12 col-md-9 col-lg-7 col-xl-6  ">
          <div class=" mt-1 shd" style=" border-radius: 15px;">
            <div class=" custom-form p-5 pb-0 custom-border" style="margin:110px">
              ...
              <form method="post" onsubmit="">
               ...
               <div class="text-center">
                ...
                <p class="text-center text-muted mt-4">Dont' have an account? <a href="../registration/registration.php" class="fw-bold text-body"><u>Register here</u></a></p>
              </form>
